...
cd /home/ubuntu/unideploy/apps/backend
python3 -m venv venv
...
cd /home/ubuntu/unideploy/apps/gateway
npm install

cd /home/ubuntu/unideploy/apps/frontend
npm install
...
# Start Brain
pm2 start "/home/ubuntu/unideploy/apps/backend/venv/bin/uvicorn main:app --host 0.0.0.0 --port 8000" --name "unideploy-brain" --cwd "/home/ubuntu/unideploy/apps/backend"

# Start Gateway
pm2 start "npm start" --name "unideploy-gateway" --cwd "/home/ubuntu/unideploy/apps/gateway"

# Start Web (Next.js)
pm2 start "npm run dev" --name "unideploy-web" --cwd "/home/ubuntu/unideploy/apps/frontend"
...
echo "1. /home/ubuntu/unideploy/apps/backend/.env"
echo "2. /home/ubuntu/unideploy/apps/gateway/.env"
echo "3. /home/ubuntu/unideploy/apps/frontend/.env"
echo "Ensure firebase-credentials.json is in /home/ubuntu/unideploy/apps/backend/"
echo "------------------------------------------------"
