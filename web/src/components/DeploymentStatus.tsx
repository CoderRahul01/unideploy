      ...
      <div className="p-8">
        ...
        {status.status === "live" && (
          <div className="mt-10 p-5 rounded-xl bg-green-500/5 border border-green-500/10 flex items-center justify-between animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div>
              <p className="text-[10px] text-green-500/60 uppercase font-black tracking-[0.2em] mb-1">
                Production URL
              </p>
              <a
                href={`http://${status.domain}`}
                target="_blank"
                className="text-sm font-semibold text-green-400 hover:underline flex items-center gap-2"
              >
